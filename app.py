...
def local_css():
    st.markdown("""
        ...
        /* Image Styling - Removed the negative margin to prevent overlap */
        .styled-image {
            display: block;
            margin-left: auto;
            margin-right: auto;
        ...
        /* The Birthday Header - Removed negative margin */
        .birthday-text {
...
if not st.session_state.authenticated:
    local_css()
    st.markdown("<h2 style='text-align: center; font-family: Montserrat; color: #333; padding-top: 50px;'>Internal Data Verification</h2>", unsafe_allow_html=True)
    ...
    st.markdown(
        ...
        <div class="personal-wish">
            <p style="letter-spacing: 5px; font-size: 12px; text-transform: uppercase; color: #00768e; margin-bottom: 20px;">For My Incredible Wife</p>
            ...
            <span style="font-size: 28px; font-family: 'Pinyon Script';">Love, [Your Name]</span>
        </div>
        """, 
        unsafe_allow_html=True
    )
